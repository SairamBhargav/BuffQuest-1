  ...
  return (
    <main className="flex min-h-[100dvh] flex-col items-center justify-center bg-gray-950 sm:p-4">
      {/* 
        ...
        On mobile (default), it's 100% width and height.
        On larger screens (sm:), it acts like a phone chassis. (430x932 is the Pro Max resolution approx)
      */}
      <div className="relative w-full h-full min-h-[100dvh] sm:min-h-0 sm:w-[430px] sm:h-[932px] sm:max-h-[95vh] sm:rounded-[3rem] sm:border-[12px] border-gray-900 overflow-hidden shadow-2xl bg-black transition-all">
