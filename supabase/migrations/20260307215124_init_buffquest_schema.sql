...
create index idx_quests_creator_id on public.quests(creator_id);
create index idx_quests_hunter_id on public.quests(hunter_id);
create index idx_quests_building_zone_id on public.quests(building_zone_id);
create index idx_quests_status on public.quests(status);
create index idx_quests_moderation_status on public.quests(moderation_status);
create index idx_quests_created_at on public.quests(created_at desc);

create index idx_messages_quest_id on public.messages(quest_id);
create index idx_messages_sender_id on public.messages(sender_id);
create index idx_messages_created_at on public.messages(created_at desc);

create index idx_attendance_user_id on public.attendance_submissions(user_id);
create index idx_attendance_building_zone_id on public.attendance_submissions(building_zone_id);
create index idx_attendance_verification_status on public.attendance_submissions(verification_status);
create index idx_attendance_submission_time on public.attendance_submissions(submission_time desc);

create index idx_reward_logs_user_id on public.reward_logs(user_id);
create index idx_reward_logs_source_type on public.reward_logs(source_type);
create index idx_reward_logs_created_at on public.reward_logs(created_at desc);